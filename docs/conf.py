# -*- coding: utf-8 -*-
#
# gbmgeometry documentation build configuration file, created by
...
master_doc = 'gbmgeometry'

# General information about the project.
project = u'gbmgeometry'
copyright = u'2016, J. Michael Burgess'
